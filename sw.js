const CACHE_NAME = "chromatica-lab-refresh-167";
const APP_SHELL = [
  "./",
  "./index.html",
  "./styles.css?v=refresh-167",
  "./supabase-config.js?v=refresh-167",
  "./practice-reminders.js?v=refresh-167",
  "./daily-login-bonus.js?v=refresh-167",
  "./daily-goal-rewards.js?v=refresh-167",
  "./quick-practice.js?v=refresh-167",
  "./app.js?v=refresh-167",
  "./auth-runtime.js?v=refresh-167",
