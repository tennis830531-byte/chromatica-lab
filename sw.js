const CACHE_NAME = "chromatica-lab-refresh-166";
const APP_SHELL = [
  "./",
  "./index.html",
  "./styles.css?v=refresh-166",
  "./supabase-config.js?v=refresh-166",
  "./practice-reminders.js?v=refresh-166",
  "./daily-login-bonus.js?v=refresh-166",
  "./daily-goal-rewards.js?v=refresh-166",
  "./quick-practice.js?v=refresh-166",
  "./app.js?v=refresh-166",
  "./auth-runtime.js?v=refresh-166",
