const CACHE_NAME = "chromatica-lab-refresh-161";
const APP_SHELL = [
  "./",
  "./index.html",
  "./styles.css?v=refresh-161",
  "./supabase-config.js?v=refresh-161",
  "./practice-reminders.js?v=refresh-161",
  "./app.js?v=refresh-161",
  "./auth-runtime.js?v=refresh-161",
