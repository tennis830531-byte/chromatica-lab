const CACHE_NAME = "chromatica-lab-refresh-160";
const APP_SHELL = [
  "./",
  "./index.html",
  "./styles.css?v=refresh-160",
  "./supabase-config.js?v=refresh-160",
  "./practice-reminders.js?v=refresh-160",
  "./app.js?v=refresh-160",
  "./auth-runtime.js?v=refresh-160",
