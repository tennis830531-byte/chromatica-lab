...
comment on function public.get_weekly_leaderboard() is
  'Returns all active joined members for the current Taipei week; members without a score row receive a computed zero and a stable row-number rank.';
